            ...
            <div class="card-set">
                <div class="row">
                    <div class="col-6">
                        <div class="box_main_1" style="background-color: #41dcfb;cursor: pointer">
                            <div class="padding_15">
                                <h2 class="speed_text" style="display: contents;color: white"><a href="{{route('changepasswordclient')}}" style="text-decoration: none;color: white">Security</a></h2><img src="{{asset('assets/security.png')}}" class="rounded" alt="..." width="60px" height="60px" style="float: right">
                    ...
                    <div class="col-6">
                        <div class="box_main_1" style="background-color: #41dcfb;cursor: pointer">
                            <div class="padding_15">
                                <h2 class="speed_text" style="display: contents;color: white"><a href="{{route('infoclient')}}" style="text-decoration: none;color: white">Account</a></h2><img src="{{asset('assets/account.png')}}" class="rounded" alt="..." width="60px" height="60px" style="float: right">
