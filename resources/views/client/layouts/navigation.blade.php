            ...
            <div class="navbar-header">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                        <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-message-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false" onclick="updateMessage()">
                            <i class='bx bx-message fs-22'></i>
                            <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger" id="nb_message"></span>
                        </button>
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                            ...
                            <div class="dropdown-head bg-primary bg-pattern rounded-top">
                                <div class="p-3">
                                    <div class="row align-items-center">
                                        <div class="col">
                                            <h6 class="m-0 fs-16 fw-semibold text-white"> Message </h6>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div data-simplebar  style="max-height: 300px;" class="pe-2">
                                        ...
                                        <div class="my-3 text-center view-all">
                                            <button type="button" class="btn btn-soft-success waves-effect waves-light">View
                                                All Message <i class="ri-arrow-right-line align-middle"></i></button>
                                        </div>
                                    </div>
                    ...
                    <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                        <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false" onclick="updateNotifications()">
                            <i class='bx bx-bell fs-22'></i>
                            <span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger" id="nb"></span>
                        </button>
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                            ...
                            <div class="dropdown-head bg-primary bg-pattern rounded-top">
                                ...
                                <div class="px-2 pt-2">
                                    <ul class="nav nav-tabs dropdown-tabs nav-tabs-custom" data-dropdown-tabs="true" id="notificationItemsTab" role="tablist">
                                        <li class="nav-item waves-effect waves-light">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#all-noti-tab" role="tab" aria-selected="true">
                                                Notifications<span class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger" style="margin-top: 13px;" id="nb_notification"></span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
                    ...
                    <div class="dropdown ms-sm-3 header-item topbar-user">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <a class="dropdown-item" href="{{route('profil')}}"><i class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Profile</span></a>
                            <a class="dropdown-item" href="apps-chat.html"><i class="mdi mdi-message-text-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Messages</span></a>
                            <a class="dropdown-item" href="{{route('addAd')}}"><i class="fa-solid fa-briefcase" style="color: #787878"></i><span class="align-middle">Post a Work</span></a>
                            <a class="dropdown-item" href="{{route('historiqueannonce')}}"><i class="fa-solid fa-clock-rotate-left" style="color: #787878"></i> <span class="align-middle">Post history</span></a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="{{route('historiquepropostionclient')}}"><i class="mdi mdi-wallet text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Your Propostion : <b>$5971.67</b></span></a>
                            <a class="dropdown-item" href="{{route('settingclient')}}"><span class="badge bg-soft-success text-success mt-1 float-end">New</span><i class="mdi mdi-cog-outline text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Settings</span></a>
                            <a class="dropdown-item" href="{{route('historiquepropostionclient')}}"><i class="mdi mdi-lock text-muted fs-16 align-middle me-1"></i> <span class="align-middle">Lock screen</span></a>
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <a class="dropdown-item" :href="route('logout')"
                                   onclick="event.preventDefault();
                                                this.closest('form').submit();" style="cursor: pointer"><i class="mdi mdi-logout text-muted fs-16 align-middle me-1"></i> <span class="align-middle" data-key="t-logout">Logout</span></a>
                            </form>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0"><a href="{{route('client')}}" style="text-decoration: none">DASHBOARD</a></h4>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i=0;i< data.length;i++) {
                        notifications+='<div class="text-reset notification-item d-block dropdown-item">'
                        notifications += '<div class="d-flex">';
                        notifications += '<img src="../../../uploads/photouser/'+ data[i].img_expedietur + '" class="me-3 rounded-circle avatar-xs" alt="user-pic">';
                        notifications += '<div class="flex-1">';
                        notifications += '<a href="#!" class="stretched-link">';
                        notifications += '<h6 class="mt-0 mb-1 fs-13 fw-semibold" id="json">' + data[i].name_expediteur + '</h6>';
                        notifications += '</a>';
                        notifications += '<div class="fs-13 text-muted">';
                        notifications += '<p class="mb-1">' + data[i].message + '</p>';
                        notifications += '</div>';
                        notifications += '<p class="mb-0 fs-11 fw-medium text-uppercase text-muted">';
                        notifications += '<span><i class="mdi mdi-clock-outline"></i> ' + data[i].created_at + '</span>';
                        notifications += '</p>';
                        notifications += '</div>';
                        notifications += '<div class="px-2 fs-15">';
                        notifications += '<div class="form-check notification-check">';
                        notifications += '</div>';
                        notifications += '</div>';
                        notifications += '</div>';
                        notifications += '</div>';
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var i=0;i< data.length;i++) {
                        notifications+='<div class="text-reset notification-item d-block dropdown-item">'
                        notifications += '<div class="d-flex">';
                        notifications += '<img src="../../../uploads/photouser/'+ data[i].img_user1 + '" class="me-3 rounded-circle avatar-xs" alt="user-pic">';
                        notifications += '<div class="flex-1">';
                        notifications += '<a href="#!" class="stretched-link">';
                        notifications += '<h6 class="mt-0 mb-1 fs-13 fw-semibold">' + data[i].name_user1 + '</h6>';
                        notifications += '</a>';
                        notifications += '<div class="fs-13 text-muted">';
                        notifications += '<a href="' + window.location.origin + '/freelancer/conversation/' + data[i].id + '" class="stretched-link">';
                        notifications += '<p class="mb-1">' + data[i].last_message + '</p>';
                        notifications += '</a>';
                        notifications += '</div>';
                        notifications += '<p class="mb-0 fs-11 fw-medium text-uppercase text-muted">';
                        notifications += '<span><i class="mdi mdi-clock-outline"></i> ' + data[i].created_at + '</span>';
    ...
    setInterval(function () {
        $(document).ready(function() {
            $.ajax({
                ...
                success: function(data) {
                    if (data==0){
                        document.getElementById("nb_message").style.display="none";
                    }else {
                        document.getElementById("nb_message").style.display="block";
                        $("#nb_message").html(data);
                    }
                },
                error: function(data) {
                    console.log(data);
...
<script>
    function updateNotifications() {
        $(document).ready(function (){
            $.ajax({
                url: '{{ route("update_nb_notification") }}',
                type: 'POST',
                data: {
                    '_token': '{{ csrf_token() }}',
                },
