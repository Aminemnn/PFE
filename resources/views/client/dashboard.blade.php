                    ...
                    <div class="modal-body">
                        ...
                        <form method="POST" action="{{route('addAd')}}" enctype="multipart/form-data">
                            ...
                            <div class="mb-1 animate__animated animate__backInLeft" id="animate2">
                                <input type="number" class="form-control" id="exampleFormControlInput1" name="nb_hours" placeholder="number of hours" min="1" style="width: 40%;margin: auto;height: 50px;border-radius: 19px;font-family: 'Trebuchet MS'">
                            </div>
                            <br>
        ...
        <div class="mySlides">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="card">
                            <img class="card-img-top" src="{{asset('../../../uploads/poste/'.$img->image)}}" alt="Card image cap" id="image2">
                            <div class="card-body">
                                <h5 class="card-title">{{$img->name_user}}</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mt-3">
                        <form  method="POST" action="{{route('freelancer')}}">
                            ...
                            <br>
                            <label style="font-family: 'Trebuchet MS'" id="labelcategory1">Sub Category</label>
                            ...
                            <select id="country" name="type" class="form-control" >
