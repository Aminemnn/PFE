            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="box_main_1">
                        <div class="zoomout frame" style="height: 350px"><img src="{{asset('uploads/poste/'.$postes->image)}}"></div>
                        <div class="padding_15">
                            ...
                            <div class="row align-items-center px-2 mt-4 mb-2">
                                ...
                                <div class="dropdown" style="margin-left: 331px">
                                    <button class="btn btn-light dropdown" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false" style="background-color: white;border-color: white;margin-top: 10px">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        <form action="{{route('delete')}}" method="post" onsubmit=" return confirm('are you sure')">
                                            @csrf
                                            <button type="submit"  class="dropdown-item" name="delete"  value="{{ $postes->id }}"  style="cursor: pointer">Delete</button >
                                        </form>
                                    </ul>
                                </div>
                            </div>
